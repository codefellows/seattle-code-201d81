...
// 3. Is there data in localStorage? If so, grab it.

let retreivedGoats = localStorage.getItem('goats');
// console.log(retreivedGoats);

// If there is data in localStorage => lets use it
...
function handleImageClick(e) {
  ...
  if (clicks === ATTEMPTS_ALLOWED) {
    ...
    // 1.  Stringify the data so it can be stored in localStorage
    // data to stringify is allGoats array
